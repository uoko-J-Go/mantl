...
.. data:: swarm_ca_cert, swarm_host_cert, swarm_key_file
   ...
   Paths to the Swarm TLS certificate, CA, and key. Defaults to the certificate
   generated by :doc:`security-setup`.

.. data:: swarm_tls_discovery_options

   Options passed to the Swarm discovery backend when Consul auth is on.
